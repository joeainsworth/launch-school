...
# create a instance variable for security logger object during initialize
# remove attr_reader :data
# create our own data method to log the request before returning the data to the client
